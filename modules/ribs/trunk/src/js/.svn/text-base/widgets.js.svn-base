    ...
    Design: {
        ...
        properties: {
            ...
            libs: {
                ...
                defaultValue: [
                    { designOnly: false,
                      value: ROOT+'lib/jquery-1.6.4.js'
                    },
                    { designOnly: true,
                      value: ROOT+'lib/jquery-ui-1.8.16.custom.js'
                    },
                    { designOnly: true,
                      value: ROOT+'src/js/template.js'
                    },
                    { designOnly: false,
                      value: ROOT+'lib/jquery.mobile-1.1.0.js'
                    },
                ]
            },
            css: {
                ...
                defaultValue: [
                    { designOnly: false,
                      value: ROOT+'src/css/jquery.mobile.structure-1.1.0.css'
                    },
                    { designOnly: false,
                      value: ROOT+'src/css/jquery.mobile.theme-1.1.0.css',
                      theme: true,
                      inSandbox: false
                    },
                    { designOnly: true,
                      value: ROOT+'src/css/template.css'
                    }
                ]
            }
        },
