...
$(function () {
    ...
    function getNeededFiles() {
        var ROOT = window.RIB_ROOT || '';
        var files = [
            ROOT+'src/css/images/ajax-loader.png',
            ROOT+'src/css/images/icons-18-white.png',
            ROOT+'src/css/images/icons-36-white.png',
            ROOT+'src/css/images/icons-18-black.png',
            ROOT+'src/css/images/icons-36-black.png',
            ROOT+'src/css/images/icon-search-black.png',
        ];
    ...
    function createZipAndExport(pid, ribFile, type) {
        ...
        if (type === 'wgt') {
            ...
            iconPath = ROOT+'src/assets/rib-48.png';
    ...
    function setDesignTheme(design, newTheme, newInSandbox) {
        ...
        if (newTheme === ROOT+'src/css/jquery.mobile.theme-1.1.0.css') {
