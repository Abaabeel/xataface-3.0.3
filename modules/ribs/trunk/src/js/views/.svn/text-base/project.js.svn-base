    ...
    $.widget('rib.projectView', $.rib.baseView, {
        ...
        createProjectBox: function(pid, container, widget) {
            var box, title, content, thumbnail, tnWrapper, rightSide,
                svgContainer, foreignHTML, ROOT = window.RIB_ROOT || '';
            widget = widget || this;
            ...
            if (foreignHTML) {
                ...
                tnWrapper.append('<img class="thumbnail" src="'+ROOT+'src/css/images/emptyProjectThumbnail.png" />');
            }
        ...
        _newSVG: function() {
            ...
            thumbnail = $('<svg class="thumbnail" xmlns="http://www.w3.org/2000/svg">\n' +
                       '<style type="text/css" >\n' +
                       '<![CDATA[\n' +
                       '@import url("'+ROOT+'src/css/thumb-jquery.mobile.structure-1.0.css");\n' +
                       '@import url("'+ROOT+'src/css/thumb-jquery.mobile-1.0.css");\n' +
                       ']]>\n' +
                       '</style>\n' +
