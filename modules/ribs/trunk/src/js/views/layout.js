    ...
    $.widget('rib.layoutView', $.rib.baseView, {
        ...
        options: {
            ...
            customHeaders: {
                ...
                'script': [
                    '<script src="'+ROOT+'lib/jquery-ui-1.8.16.custom.js"></script>',
                    '<script src="'+ROOT+'src/js/jquery-workarounds.js"></script>',
                    '<script src="'+ROOT+'src/js/composer.js"></script>'
                ],
                'link': [
                    '<link href="'+ROOT+'src/css/composer.css" rel="stylesheet">'
                ]
            }
        },
...
*/
        ...
        _renderer: function (admNode, domNode) {
            ...
            if ((admNode.getType() === "Image") && (!admNode.getProperty('src'))) {
                if ($(domNode).is('img')) {
                    $(domNode).attr('src', ROOT+"src/css/images/widgets/tizen_image.svg");
                }
            }
        }
    });
